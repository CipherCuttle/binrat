/** Source-backed Pons V2 launch snapshot contracts shared by the backend indexer.
 * The historical schema name is retained for compatibility, not as a frontend.
 * This bounded window is not full creator history or a funding trace. */
